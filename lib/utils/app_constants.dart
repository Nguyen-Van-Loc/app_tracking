...
class AppConstants {
  ...
  static const String TOKENDEVICE = '/mita/users/token-device';
  static const String TRACKING_GET_POST = '/mita/tracking';
  static const String TRACKING_UPDATE_DEL = '/mita/tracking/';
  static const String APP_VERSION = "1.0.0";
  static const String BASE_URL_UPDATE= "/mita/users/update/";
  static const String BASE_URL = 'http://android-tracking.oceantech.com.vn';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String SEARCH_BY_PAGE = '/mita/users/searchByPage';
  static const String GET_NEWS = '/mita/posts/get-news';
  static const String POST_NEWS = '/mita/posts/create';
  static const String GET_NOTIFI = '/mita/notifications';
  static const String LIKE_NEWS = '/mita/posts/likes/';
  static const String COMMENTS_NEWS = '/mita/posts/comments/';
